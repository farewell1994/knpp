...
})->form(function ()
{
	...
	наприклад \'knpp.com.ua/public/view/test\'. Частину test потім вкажете в розділі Мапи, в полі URL при детальному описі маршруту')->required();
	FormItem::textarea('links', 'Посилання на 4 фото (розділяти символом *). Наприклад: image1.jpg*image2.jpg*image3.jpg. Не обов\'язково');
});